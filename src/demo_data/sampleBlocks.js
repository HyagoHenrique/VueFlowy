module.exports = [
  ...
  },
  {
    preview: {
      title: 'Call Doctor',
      description: 'Api Will Call Doctor',
      icon: 'heart',
    },
    node: {
      title: 'API CALL Doctor',
      description: '<span>Call the doctor</span>',
      icon: 'heart',
    },
  },
  {
    preview: {
      title: 'Logs',
      description: 'Api Will Logs all messages',
      icon: 'databaseorange',
    },
    node: {
      title: 'API CALL',
      description: '<span>Logs all messages</span>',
      icon: 'databaseorange',
    },
  },
];
